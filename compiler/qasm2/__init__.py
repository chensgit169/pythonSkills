...
.. code-block:: python
    ...
    from compiler.circuit import Gate
    from compiler.qasm2 import loads, CustomInstruction
...
.. code-block:: python
    ...
    import math
    from compiler.qasm2 import loads, CustomClassical
...
.. code-block:: python
    ...
    from compiler.converters import ast_to_dag, dag_to_circuit
    from compiler.qasm import Qasm
