...
.. code-block:: python
    ...
    from qasm_compiler.circuit import Gate
    from qasm_compiler.qasm2 import loads, CustomInstruction
...
.. code-block:: python
    ...
    import math
    from qasm_compiler.qasm2 import loads, CustomClassical
...
.. code-block:: python
    ...
    from qasm_compiler.converters import ast_to_dag, dag_to_circuit
    from qasm_compiler.qasm import Qasm
...
from compiler.circuit import QuantumCircuit
