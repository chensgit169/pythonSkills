...
while providing reasonable control over how the individual visualization are created.
...
# Hide x labels and tick labels for top visualization and y ticks for right visualization.
for ax in axs.flat:
    ax.label_outer()
