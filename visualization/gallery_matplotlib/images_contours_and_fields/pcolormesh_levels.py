...
`.axes.Axes.pcolormesh` allows you to generate 2D image-style visualization.
...
# and `.axes.Axes.imshow` type visualization in a similar
...
# contours are *point* based visualization, so convert our bound into point
# centers
